...
import { CreateTocOrderAddressDto } from 'src/toc-order-address/dto/create-toc-order-address.dto'
import { CreateTocOrderProductDto } from 'src/toc-order-product/dto/create-toc-order-product.dto'

export class CreateTocOrderDto {
  @IsString()
  ...
  @Type(() => CreateTocOrderProductDto)
  products: CreateTocOrderProductDto[]

  @IsNotEmpty({ message: '收货地址不可以为空' })
  @ValidateNested()
  @Type(() => CreateTocOrderAddressDto)
  addressInfo: CreateTocOrderAddressDto
}
